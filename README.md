🐶 DogStore - Tienda Web con Django desarrollado por Alejandra Duarte para el bootcamp de Talento Digital

Proyecto de tienda online desarrollado con Django, enfocado en la venta de productos para mascotas .
Incluye sistema de categorías, catálogo dinámico y estilos personalizados con SCSS + Bootstrap 5.
...
-Diseño personalizado con Bootstrap + SCSS
